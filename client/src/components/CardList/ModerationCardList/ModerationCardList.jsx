...
import ModerationCard from "../../Card/ModerationCard/ModerationCard";
import Loader from "../../Loader/Loader";

function ModerationCardList() {
        ...
        <ul className="w-full gap-4 flex flex-wrap justify-around">
          {channels.map((channel, index) => {
            return (
              ...
              >
                <ModerationCard key={channel.id} channel={channel} />
              </li>
            );
          })}
        </ul>
...
export default ModerationCardList;
